...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    $updateProduct = $pd->productUpdate($_POST, $_FILES, $id);//for images $_files
    				...
    				<tr>
                        ...
                        <td>
                            <select id="select" name="type">
                                ...
                                <?php
                                if ($value['type'] == 0) { ?>
                                    <option selected='selected' value="0">Com Recursos</option>
                                    <option value="1">Genérico</option>
                                <?php
                                } else { ?>
                                    <option value="0">Com Recursos</option>
                                    <option selected='selected' value="1">Genérico</option>
                                <?php
                                }
                                ?>
