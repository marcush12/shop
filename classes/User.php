...
class User {
    ...
    public function customerRegistration($data) {
        ...
        if ($mailchk != false) {
            $msg ="<span class='error'>O email já está sendo usado.</span>";
            return $msg;
        } else {
            ...
            if ($inserted_row) {
                $msg ="<span class='success'>Cliente registrado com sucesso</span>";
                return $msg;
            } else {
               $msg ="<span class='error'>Cliente não foi registrado</span>";
               return $msg;
            }
        }
    }
    ...
    public function customerLogin($data) {
        ...
        if ($result !=false) {
            ...
            $msg ="<span class='error'>Email ou senha inválidos</span>";
            return $msg;
        }
    }
    ...
    public function customerUpdate($data, $cmrId) {
        ...
        if ($name == "" || $address == "" || $city == "" || $country == "" || $zip == "" || $phone == "" || $email == "") {
            ...
            if ($update_row) {
                $msg = "<span class='success'>Seu Perfil foi atualizado com sucesso</span>";
                return $msg;
            } else {
                $msg = "<span class='error'>Seu Perfil não foi atualizado</span>";
                return $msg;
            }
        }
    }
